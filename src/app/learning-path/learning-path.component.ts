...
export class LearningPathComponent {
  learnPathAry = [
    {
      tittle: 'UI/UX Design',
      subTittle: 'Master user interface and experience design with industry-standard tools',
      week: '12 weeks',
      lvl: 'Beginner to Advanced',
      points: ['Figma & Adobe XD', 'User Research', 'Prototyping', 'Design Systems'],
      isPopular: true,
    ...
    },
    {
      ...
      subTittle: 'Learn comprehensive digital marketing strategies and analytics',
      week: '10 weeks',
    ...
    },
    {
      ...
      subTittle: 'Build modern web applications with React and advanced JavaScript',
      week: '16 weeks',
      lvl: 'Intermediate',
      points: ['React/Next.js', 'TypeScript', 'CSS / Tailwind', 'API Integration'],
      isPopular: false,
    ...
    },
    {
      ...
      week: '8 weeks',
      lvl: 'Intermediate',
      points: ['iOS/Android Design', 'Mobile UX', 'App Prototyping', 'User Testing'],
      isPopular: false,
    ...
    },
    {
      ...
      week: '14 weeks',
      lvl: 'Beginner to Advanced',
      points: ['Python/SQL', 'Data Visualization', 'Statistical Analysis', 'Business Intelligence'],
      isPopular: false,
    ...
    },
    {
      ...
      points: ['Product Strategy', 'User Research', 'Agile Methodology', 'Stakeholder Management'],
      isPopular: false,
